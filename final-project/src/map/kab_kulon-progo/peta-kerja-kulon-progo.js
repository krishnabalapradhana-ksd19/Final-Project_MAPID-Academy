...
const KAB_NAME = 'Kulon Progo';
const KAB_LABEL = 'Kabupaten Kulon Progo';

// Urutan tetap kecamatan di Kabupaten Kulon Progo + warna kategorikal
  ...
  app.innerHTML = `
    <header class="topbar">
      <div class="topbar-left">
        <img class="brand-logo" src="${kabLogo}" alt="Logo Kabupaten Kulon Progo" />
        <div>
          <div class="brand-title">LBS Kulon Progo</div>
    ...
    <div class="body-row">
      ...
      <aside class="panel" id="panel">
        <div class="panel-header">
          <h1 id="panel-title">Kabupaten Kulon Progo</h1>
        ...
        <div class="panel-section">
          ...
          <div class="chip-row" id="kec-filter">
            <button class="chip active" type="button" data-kec="">Semua Kulon Progo</button>
          </div>
        </div>
        ...
        <div class="stat-grid">
          ...
          <div class="stat-card">
            <div class="stat-label">% dari Kulon Progo</div>
...
function setBasemap(key) {
  ...
  const beforeId = map.getLayer('lbs-kulon-progo-fill') ? 'lbs-kulon-progo-fill' : undefined;
...
function setActiveKec(kec) {
  ...
  if (map.getLayer('lbs-kulon-progo-fill')) {
    map.setFilter('lbs-kulon-progo-fill', kec ? ['==', ['get', 'WADMKC'], kec] : null);
    map.setFilter('lbs-kulon-progo-outline', kec ? ['==', ['get', 'WADMKC'], kec] : null);
  }
...
map.on('load', async () => {
  ...
  map.addLayer({
    id: 'lbs-kulon-progo-fill',
    type: 'fill',
    source: 'lbs-kulon-progo',
    paint: {
...
function setupFeaturePopup() {
  ...
  map.on('click', 'lbs-kulon-progo-fill', (e) => {
  ...
  map.on('mouseenter', 'lbs-kulon-progo-fill', () => {
    map.getCanvas().style.cursor = 'pointer';
  });
  map.on('mouseleave', 'lbs-kulon-progo-fill', () => {
