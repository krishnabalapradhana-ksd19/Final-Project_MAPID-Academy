...
const KAB_NAME = 'Sleman';
const KAB_LABEL = 'Kabupaten Sleman';

// Urutan tetap kecamatan di Kabupaten Sleman + warna kategorikal
  ...
  app.innerHTML = `
    <header class="topbar">
      <div class="topbar-left">
        <img class="brand-logo" src="${slemanLogo}" alt="Logo Kabupaten Sleman" />
        <div>
          <div class="brand-title">LBS Sleman</div>
    ...
    <div class="body-row">
      ...
      <aside class="panel" id="panel">
        <div class="panel-header">
          <h1 id="panel-title">Kabupaten Sleman</h1>
        ...
        <div class="panel-section">
          ...
          <div class="chip-row" id="kec-filter">
            <button class="chip active" type="button" data-kec="">Semua Sleman</button>
          </div>
        </div>
        ...
        <div class="stat-grid">
          ...
          <div class="stat-card">
            <div class="stat-label">% dari Sleman</div>
...
function setBasemap(key) {
  ...
  const beforeId = map.getLayer('lbs-sleman-fill') ? 'lbs-sleman-fill' : undefined;
...
function setActiveKec(kec) {
  ...
  if (map.getLayer('lbs-sleman-fill')) {
    map.setFilter('lbs-sleman-fill', kec ? ['==', ['get', 'WADMKC'], kec] : null);
    map.setFilter('lbs-sleman-outline', kec ? ['==', ['get', 'WADMKC'], kec] : null);
  }
...
function setupFeaturePopup() {
  ...
  map.on('click', 'lbs-sleman-fill', (e) => {
  ...
  map.on('mouseenter', 'lbs-sleman-fill', () => {
    map.getCanvas().style.cursor = 'pointer';
  });
  map.on('mouseleave', 'lbs-sleman-fill', () => {
